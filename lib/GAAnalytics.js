...
let GAAnalytiics = _decorate(null, function (_initialize, _HeLxAnalyticsTracker) {
  class GAAnalytiics extends _HeLxAnalyticsTracker {
  ...
  return {
    ...
    d: [{
      kind: "method",
      key: "setup",
      value: async function setup(setupData) {
        const {
          trackingId,
          options
        } = setupData;
      ...
      kind: "method",
      decorators: [waitsForSetup()],
      key: "trackEvent",
      value: async function trackEvent(event) {
      ...
      decorators: [waitsForSetup()],
      key: "trackRoute",
      value: async function trackRoute(route) {
